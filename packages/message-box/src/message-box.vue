    ...
    <transition name="msgbox-bounce">
      <div class="mint-msgbox mt-bg-white" v-show="value">
        ...
        <div class="mint-msgbox-btns">
          <button class="mint-msgbox-btn mint-msgbox-cancel mt-btn-default" v-show="showCancelButton" @click="handleAction('cancel')" >{{ i18n.buttonCancel }}</button>
          <button class="mint-msgbox-btn mint-msgbox-confirm mt-btn-primary" v-show="showConfirmButton" @click="handleAction('confirm')">{{ i18n.buttonConfirm }}</button>
        </div>
      </div>
    </transition>
  </div>
      ...
      validate() {
        if (this.$type === 'prompt') {
          ...
          if (inputPattern && !inputPattern.test(this.inputValue || '')) {
            this.editorErrorMessage = this.inputErrorMessage || this.i18n.inputDataInvalid;
