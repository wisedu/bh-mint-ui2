...
<script type="text/ecmascript-6">
  import visibilityMixin from '../common/visibility'
  import popupMixin from '../common/popup'
...
<style>
  ...
  .cube-popup-center .cube-popup-content,.cube-popup-right .cube-popup-content,.cube-popup-left .cube-popup-content {
    top: -50%;
    left: -50%;
    width: auto;
    max-width: 100%;
  ...
  .cube-popup-right .cube-popup-content,.cube-popup-left .cube-popup-content{
    height: 100%;
    top: -100%;
  }
